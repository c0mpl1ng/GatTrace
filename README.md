...
- 🌐 **跨平台支持** - Windows、Linux、macOS 全平台兼容，支持 32 位和 64 位架构
...
- 🏗️ **32位架构支持** - 新增 Windows 386、Linux 386、Linux ARM 32位支持
- 🔧 **Go 1.20 兼容** - 降级到 Go 1.20 以支持 Windows 7 系统
- 🛡️ **隐私保护增强** - 添加 -trimpath 标志移除编译路径信息
- 🔄 **跨平台构建优化** - 支持 9 个不同平台和架构的构建
- 🐛 **32位兼容性修复** - 修复 syscall.Stat_t 时间字段类型转换问题
...
2. 搜索现有的 [Issues](https://github.com/c0mpl1ng/GatTrace/issues)
3. 创建新的 Issue 描述问题
